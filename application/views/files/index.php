...
<div class="submenu">
   <ul>
      <li><?php echo Html::anchor('file/edit', __('Add new file'))?></li>
   </ul>
   <br style="clear:both;">
</div>
<h1><?php echo __('Manage files'); ?></h1>
<div class="content">
<?php
echo $paging->render();
...
$column_list = array( 'username'    => array(
                                          'label' => __('Username')
                                          ),
                       'role'       => array(
                                            'label' => __('Role(s)'),
